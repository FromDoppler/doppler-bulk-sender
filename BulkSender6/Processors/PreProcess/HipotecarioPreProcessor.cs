...
namespace Doppler.BulkSender.Processors.PreProcess
{
    ...
    {
        public HipotecarioPreProcessor(ILogger logger, IAppConfiguration configuration) : base(logger, configuration) { }
        ...
        public override void ProcessFile(string fileName, IUserConfiguration userConfiguration)
        {
            ...
            {
                _logger.LogError($"ERROR HIPOTECARIO PRE PROCESSOR: {e}");
            }
        }
    }
}
